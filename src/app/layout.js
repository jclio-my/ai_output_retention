    ...
    <html lang="zh-CN" suppressHydrationWarning>
      <body className="bg-white dark:bg-[#121212] transition-colors duration-300 min-h-screen flex flex-col">
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem>
          ...
          {/* 底部导航 */}
          <footer className="w-full py-2 pb-3 text-center space-y-1 bg-white/90 dark:bg-[#121212]/90 backdrop-blur-sm fixed bottom-0 left-0 border-t border-gray-100 dark:border-gray-800 z-40">
            {/* 第一行: 导航 */}
            ...
            {/* 第二行: 作者 */}
            <div className="text-xs text-gray-500 dark:text-gray-600 font-light">
              ©jclio
            </div>
          </footer>
